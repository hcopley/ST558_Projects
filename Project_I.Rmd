...
The `plot.county()` plotting method will filter to a set of counties within a single user-provided state, and plot those county-level values by year. In this method we will allow the user a bit more flexibility. 
